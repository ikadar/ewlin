#!/bin/bash
# Flux Scheduler - Server Deploy for LGI instance (run on the production server)
...
INSTANCE="lgi"
DC="docker compose --env-file .env.production -f docker-compose.yml -f docker-compose.prod-lgi.yml"

echo "=========================================="
echo "Flux Scheduler - Server Deploy [LGI]"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "LGI deployment complete!"
echo "=========================================="
echo ""
echo "Check status: $DC ps"
echo "Check health: curl http://localhost:9003/api/v1/schedule/snapshot"
