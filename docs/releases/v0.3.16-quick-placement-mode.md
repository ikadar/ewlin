# Release v0.3.16 – Quick Placement Mode
...
- Job navigation shortcuts (ALT+↑/↓) - deferred to v0.3.17
...
```
apps/web/src/
├── App.tsx                              # Mode state, toggle handlers, click-to-place
├── utils/
│   ├── quickPlacement.ts                # NEW: Task selection logic
│   ├── quickPlacement.test.ts           # NEW: Unit tests
│   └── index.ts                         # Export quickPlacement
├── components/
│   ├── PlacementIndicator/              # NEW: Directory
│   │   ├── PlacementIndicator.tsx       # NEW: Glowing line component
│   │   ├── PlacementIndicator.test.tsx  # NEW: Tests
│   │   └── index.ts                     # NEW: Export
│   ├── JobDetailsPanel/
│   │   └── TaskTile.tsx                 # Modify: Add isActivePlacement prop
│   ├── StationColumns/
│   │   └── StationColumn.tsx            # Modify: Add cursor state, hover tracking
│   └── SchedulingGrid/
│       └── SchedulingGrid.tsx           # Modify: Pass quick placement props
```
