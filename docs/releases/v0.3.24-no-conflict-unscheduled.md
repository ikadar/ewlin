...
- [ ] **Remove conflict for unscheduled predecessors**
...
- [ ] **Update tests for new behavior**
  ...
  - Files: `packages/validator/src/validators/precedence.test.ts`
...
- [ ] No conflict when predecessor is unscheduled
- [ ] Conflict when predecessor is scheduled and ends after proposed start
- [ ] No conflict when predecessor is scheduled and ends before proposed start
- [ ] Multiple predecessors - only check scheduled ones

### Manual Testing

- [ ] Can place Task 3 when Tasks 1 and 2 are unscheduled
- [ ] Can place Task 2 when Task 1 is unscheduled (after Task 3 placed)
- [ ] Conflict shown when Task 1 is scheduled after Task 2's start time
- [ ] Backward scheduling workflow works smoothly
...
- [ ] Merged to ux-ui-development branch (frontend) and main (validator package)
