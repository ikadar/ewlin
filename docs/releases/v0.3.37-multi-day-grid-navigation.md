# Release v0.3.37 – Multi-Day Grid Navigation
...
- Click on DateStrip day → Grid scrolls to that day's start

### Scroll Synchronization

```
DateStrip (Y-scroll) ←→ Grid (Y-scroll)
       ↓                    ↓
...
- [x] DateStrip click scrolls smoothly to target day
- [x] Scroll sync feels natural (not jittery)
- [x] Departure date clearly visible (red styling)
- [x] Scheduled days dots visible (emerald)
- [x] Grid lines extend correctly for all days
