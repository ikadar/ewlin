# Release v0.3.6 – Timeline Column
...
- [x] **Time calculation**
  ...
  - Files: `apps/web/src/components/TimelineColumn/utils.ts`
...
- [x] **Add TimelineColumn to App layout**
...
- [x] TimelineColumn renders with correct width
- [x] Hour markers display correct labels
- [x] Tick marks are positioned correctly
- [x] NowLine shows current time
- [x] NowLine position updates based on time
- [x] Hour range is configurable (startHour, hourCount)
...
- [x] All unit tests passing (209/209)
- [x] TypeScript compiles without errors
- [x] Lint passes
- [x] Documentation updated
- [x] Git tag created: `v0.3.6`
...
├── TimelineColumn/
│   ├── index.ts              # Exports
│   ├── TimelineColumn.tsx    # Main container
│   ├── TimelineColumn.test.tsx # Tests
│   ├── HourMarker.tsx        # Hour with label and ticks
