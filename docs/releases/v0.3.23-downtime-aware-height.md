...
- [ ] Height calculation uses scheduledEnd - scheduledStart
- [ ] Setup/run ratios maintained for stretched tiles
- [ ] Handles same-day assignments (no stretching)
- [ ] Handles overnight assignments (with stretching)

### Manual Testing

- [ ] Tile height matches time span on grid
- [ ] Stretched tiles visually span across non-operating periods
- [ ] Normal tiles (no stretching) display correctly
- [ ] Setup and run sections scale proportionally
- [ ] Multiple stretched tiles on same station don't overlap
