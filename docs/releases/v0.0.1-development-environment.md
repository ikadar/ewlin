# Release v0.0.1 – Development Environment
...
This is a **infrastructure-only** release with no application code – just container orchestration and configuration.
...
- [x] **MariaDB initialization script**
  ...
  - Tests: Grants applied after fresh start ✅
