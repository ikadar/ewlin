...
- [ ] Drag tile from top edge - tile position matches cursor on drop
- [ ] Drag tile from middle - tile top maintains relative position
- [ ] Drag preview visually aligns with drop position
- [ ] Works for new placements from Job Details Panel
- [ ] Works for existing tiles on grid
