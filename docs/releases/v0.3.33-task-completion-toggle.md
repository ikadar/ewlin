# Release v0.3.33 – Task Completion Toggle
...
- [ ] Click incomplete icon → tile shows completed icon
- [ ] Click completed icon → tile shows incomplete icon
...
**Expected Results:**
- [ ] Hover: cursor changes to pointer, color lightens (zinc-600 → zinc-400)
...
**Expected Results:**
- [ ] Incomplete → Complete: segment turns green
- [ ] Complete → Incomplete: segment turns gray (scheduled) or border-only (unscheduled)
...
- State flows through App.tsx → SchedulingGrid → Tile
```
