...
- [ ] **Add StationHeaders to App layout**
...
- [ ] StationHeaders renders all stations
- [ ] StationHeader displays station name
- [ ] OffScreenIndicator shows correct count
- [ ] OffScreenIndicator shows correct direction (up/down)
- [ ] Header has sticky positioning
- [ ] Headers have correct width (w-60)
