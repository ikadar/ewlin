...
**Feature:** SCHED-041 (Realtime Validation Feedback)
...
**Feature:** SCHED-042 (ALT Key Validation Bypass)
**Fixture:** `alt-bypass`
**Priority:** P1
...
**Feature:** SCHED-044, SCHED-045 (Tile Swap Buttons)
**Fixture:** `swap`
**Priority:** P1
...
**Feature:** SCHED-048, SCHED-049 (Keyboard Shortcuts)
**Fixture:** `swap`
**Priority:** P2
...
**Feature:** SCHED-052 (Double-Click Recall)
**Fixture:** `test`
**Priority:** P1
...
**Feature:** SCHED-053 (Single-Click Jump)
**Fixture:** `test`
**Priority:** P2
...
**Feature:** SCHED-054 (Selection Glow Effect)
**Fixture:** `test`
**Priority:** P2

**Preconditions:**
- Multiple jobs with tiles on grid
...
**Feature:** SCHED-058 (Station Compact)
**Fixture:** `test`
**Priority:** P2
...
**Feature:** SCHED-063 (Grid Tile Drag)
**Fixture:** `test`
**Priority:** P1
...
**Feature:** SCHED-073 (Job Focus Muting)
**Fixture:** `test`
**Priority:** P2
...
**Feature:** SCHED-074 (Persistent Amber Glow)
**Fixture:** `alt-bypass`
**Priority:** P2
...
**Feature:** SCHED-075 (Conflict Glow Priority)
**Fixture:** `alt-bypass`
**Priority:** P3
...
**Feature:** SCHED-078 (Drag Snapping)
**Fixture:** `sidebar-drag`
**Priority:** P2

**Preconditions:**
- SIDE-001 job selected
- Unscheduled task visible in sidebar
...
**Feature:** SCHED-083 (Task Completion Toggle)
**Fixture:** `test`
**Priority:** P1
