...
const mockStations: Station[] = [
  {
    ...
    operatingSchedule: {
      ...
      tuesday: { isOperating: true, slots: [{ start: '07:00', end: '19:00' }] },
      wednesday: { isOperating: true, slots: [{ start: '07:00', end: '19:00' }] },
      thursday: { isOperating: true, slots: [{ start: '07:00', end: '19:00' }] },
      friday: { isOperating: true, slots: [{ start: '07:00', end: '19:00' }] },
