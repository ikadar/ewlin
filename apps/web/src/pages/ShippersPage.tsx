    ...
    <div className="min-h-screen bg-zinc-900 flex flex-col">
      ...
      <header className="border-b border-zinc-800 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-semibold text-zinc-100">Transporteurs</h1>
        </div>
        <button
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  {filteredShippers.map((shipper) => (
                    ...
                    >
                      <td className="px-4 py-3 text-zinc-100 font-medium">{shipper.name}</td>
      ...
      {deletingShipper && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
          <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6 max-w-sm w-full mx-4 shadow-xl">
            <h2 className="text-zinc-100 font-medium mb-2">Supprimer le transporteur</h2>
            <p className="text-sm text-zinc-400 mb-4">
              Supprimer{' '}
              <span className="font-medium text-zinc-200">{deletingShipper.name}</span> ?
