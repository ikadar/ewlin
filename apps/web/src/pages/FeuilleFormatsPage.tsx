              ...
              <table className="w-full text-sm">
                <thead className="bg-flux-hover">
                  <tr className="bg-flux-hover border-b border-flux-border text-flux-text-secondary">
                    <th className="text-left px-4 py-1.5 font-medium">Format</th>
                    <th className="text-left px-4 py-1.5 font-medium">Poses</th>
                ...
                <tbody>
                  ...
                  {filteredFormats.map((fmt) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-1.5 text-flux-text-secondary font-mono text-xs">
