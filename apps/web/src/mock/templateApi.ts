    ...
    elements: [
      {
        ...
        qteFeuilles: '',
        commentaires: '',
        sequence: 'KomoriG40(25)\nPolar137(10)',
        sequenceWorkflow: ['Presse offset', 'Massicot'],
      },
      {
        name: 'CAH1',
        precedences: '',
    ...
    elements: [
      {
        ...
        sequence: 'KomoriG40(25)\nPolar137(10)\nSemipack(20)',
        sequenceWorkflow: ['Presse offset', 'Massicot', 'Pelliculeuse'],
      },
      {
        name: 'CAH1',
        precedences: '',
  ...
  // --- Route 7: Brochure assemblée piquée (Int→Offset+Massicot, Couv→Offset+Massicot, Ass→Ass.piqueuse+Cond) ---
  {
    ...
    elements: [
      ...
      },
      {
        ...
        sequence: 'HorizonASS(90)\nFilmeuse(30)',
        sequenceWorkflow: ['Assembleuse-piqueuse', 'Conditionnement'],
      },
    ],
    ...
    elements: [
      {
        ...
        sequence: 'KomoriG40(40)\nPolar137(15)\nSemipack(20)\nSBG(60)\nCarton(25)',
        sequenceWorkflow: ['Presse offset', 'Massicot', 'Pelliculeuse', 'Typographie', 'Conditionnement'],
      },
    ],
  ...
  // --- Route 6: Liasse (Feuillets→Offset+Massicot, Assemblage→Assembleuse+Cond) ---
  {
    ...
    elements: [
      ...
      },
      {
        ...
        sequence: 'Horizon60H(45)\nCarton(20)',
        sequenceWorkflow: ['Assembleuse', 'Conditionnement'],
      },
    ],
